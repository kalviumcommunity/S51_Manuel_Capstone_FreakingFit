...
function Veg() {
  return (
    <div>
      ...
      <p>Ensure to drink plenty of water throughout the day to stay hydrated. Adjust portion sizes based on your individual calorie and macronutrient requirements.</p>
    </div>
  )
}
